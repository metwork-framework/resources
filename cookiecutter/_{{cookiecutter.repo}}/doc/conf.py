...
latex_documents = [
    (master_doc, '{{cookiecutter.repo}}.tex',
     u'{{cookiecutter.repo}} Documentation',
     u'MetWork', 'manual'),
]
...
man_pages = [
    (master_doc, '{{cookiecutter.repo}}', u'{{cookiecutter.repo}} Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, '{{cookiecutter.repo}}', u'{{cookiecutter.repo}} Documentation',
     author, '{{cookiecutter.repo}}', 'One line description of project.',
     'Miscellaneous'),
]
